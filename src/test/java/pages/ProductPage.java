...
public class ProductPage extends BasePage {
    private static final By WANTED_QUANTITY = By.id("quantity_wanted");
    private static final By WANTED_SIZE = By.id("group_1");
    private static final By CART_QUANTITY_TEXT = By.className("ajax_cart_quantity");
    private static final By ADD_TO_CART_BUTTON = By.xpath("//button[@name='Submit']");
